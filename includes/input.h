...
/*   Updated: 2016/12/20 11:46:35 by mploux           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define KEY_N_MUL 67
# define KEY_N_DIV 75
# define KEY_N_ENTER 76
# define KEY_N_EQUALS 81
# define KEY_N_CLEAR 71
# define KEY_ENTER 36
# define KEY_TAB 48
...
int				mouse_up_hook(int button, t_data *data);
int				mouse_down_hook(int button, t_data *data);
